...
const KeynoteInApp = () => {
  ...
  const loadSpeakers = async () => {
    try {
      setLoading(true);
      console.log("Loading speakers from local backend...");
      const speakersList = await backend.getKeynoteSpeakers();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingSpeaker) {
        ...
        await backend.updateKeynoteSpeaker(editingSpeaker.id, speakerData);
        console.log("Speaker updated successfully");
      } else {
        console.log("Adding new speaker to backend...");
        await backend.addKeynoteSpeaker(speakerData);
  ...
  const handleDelete = async (speaker) => {
    ...
    try {
      ...
      await backend.deleteKeynoteSpeaker(speaker.id);
      await loadSpeakers();
    } catch (error) {
