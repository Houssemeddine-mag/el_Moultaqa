  ...
  return (
    <main className="landing-main">
      ...
      <div className="landing-content">
        {/* Full-width discover panel */}
        <section className="home-discover-panel">
          <div className="home-discover-content">
            <span className="home-discover-badge">Community</span>
            <h2>Discover conferences happening now</h2>
            <p>
              Browse academic and research conferences across Algeria. Find events
              by category, explore speakers, and join the conversation.
            </p>
            <button className="hero-button" onClick={() => window.location.href = "/discovery"}>
              Explore conferences
          ...
          <div className="home-discover-visual">
            <div className="home-discover-grid-bg">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="home-discover-grid-dot" style={{ animationDelay: `${i * 0.3}s` }} />
              ))}
            </div>
          </div>
        </section>
